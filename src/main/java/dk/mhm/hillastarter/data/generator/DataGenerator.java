package dk.mhm.hillastarter.data.generator;

import com.vaadin.exampledata.DataType;
import com.vaadin.exampledata.ExampleDataGenerator;
import com.vaadin.flow.spring.annotation.SpringComponent;
import dk.mhm.hillastarter.data.Role;
import dk.mhm.hillastarter.data.entity.SamplePerson;
import dk.mhm.hillastarter.data.entity.User;
import dk.mhm.hillastarter.data.service.SamplePersonRepository;
import dk.mhm.hillastarter.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 4, 2, 0, 0, 0));
